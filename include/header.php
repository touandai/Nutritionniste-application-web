...
<body>
    ...
    <nav id="menu" class="navbar navbar-expand-sm">
            ...
            <ul class="navbar-nav id="navbarContent">
                ...
                <li class="menu nav-item"><a href="pages/consultation.html">Consultations/Tarifs</a>
                <li class="menu nav-item"><a href="pages/recettes.html">Recettes de base</a></li>
                <li class="menu nav-item">
                    <?php
                        if(isset($_SESSION['info_patients'])) {
                            //Si l'utilisateur est connecté
                    ?>
                    <a href="pages/mesinfos.php">Mon compte</a>
                    <?php
                    } else {
                            //Si l'utilisateur n'est pas connecté
                    ?>
                    <a href="pages/monespace.php">Espace client</a>
                    <?php
                    }
                    ?>
                    <!--  -->
